...
let n=0,i=0,a=0,o=0,r=0,l=e.clientWidth,c=e.clientHeight;
s&&t.addEventListener("mousemove",function(t,e){
    let s=null,n=e;return(...e)=>{let i=Date.now();
    ...
    !function(e,s){
        ...
        for(let t=0;t<s.length;t++){
            const e=s[t].getAttribute("data-translating-factor")||20,n=s[t].getAttribute("data-rotating-factor")||20,i=s[t].getAttribute("data-perspective")||500;
            let a=[];
